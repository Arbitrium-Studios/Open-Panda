...
"thirdparty\win-python3.11-x64\python" makepanda/makepanda.py --everything --installer --msvc-version=14.3 --windows-sdk=11 --no-eigen --threads=%THREADS%
PAUSE
